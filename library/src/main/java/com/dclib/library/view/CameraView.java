package com.dclib.library.view;
...
import com.dclib.camera.R;
import com.dclib.library.listener.CameraListener;
import com.dclib.library.listener.CaptureListener;
import com.dclib.library.listener.ClickListener;
import com.dclib.library.listener.ErrorListener;
import com.dclib.library.listener.TypeListener;
import com.dclib.library.state.CameraMachine;
import com.dclib.library.util.ScreenUtil;
import com.dclib.library.util.ThreadUtils;
...
public class CameraView extends FrameLayout implements SurfaceHolder.Callback, ICameraView {
    ...
    public CameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        duration = DEFAULT_VIDEO_RECORD_MAX_TIME * 1000;
        a.recycle();
        initData();
        initView();
    }
    ...
    private void initView() {
        ...
        mCaptureLayout.setCaptureListener(new CaptureListener() {
            ...
            public void recordShort(final long time) {
                mCaptureLayout.setTextWithAnimation(mContext.getString(R.string.record_time_tip));
    ...
    public void onResume() {
        Log.i(TAG, "ICameraView onResume");
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        Log.i(TAG, "ICameraView SurfaceCreated");
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        Log.i(TAG, "ICameraView SurfaceDestroyed");
